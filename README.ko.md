...
기본 effort: medium. 복잡한 planning에는 high 또는 xhigh를 권장합니다 (사용자 선택).
...
| `~/.claude/CLAUDE.md` | Claude Code 규칙 (auto-generated: orchestrator 또는 helper 모드) |
...
| `shared/claude-wrapper-main.md` | Claude가 메인일 때의 규칙 |
| `shared/claude-wrapper-helper.md` | Claude가 헬퍼일 때의 규칙 |
