...
- Shell: use git, npm, agy, and project test commands as needed.
...
## Docs Delegation
Documentation fallback order is agy, then Codex, then Claude. Use agy first for long-form docs such as READMEs, changelogs, API docs, and extensive inline comments:
